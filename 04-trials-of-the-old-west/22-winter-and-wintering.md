...
>
> "We're short," she said to the boy, who was keeping the tally. "We're short the hay and we're short the coal and we're short the coffee, and the coffee is the one that will kill us if the snow doesn't."
>
> "I can take the mule to the county seat for coal."
>
...
The Winter Quarter is an interlude layered on the Turn of the Season, resolved in place of the ordinary season's business rolls for the winter season. The winter season is not a season of business; it is a season of holding on. Resolve the Winter Quarter in this order, at the table, when the campaign's calendar reaches December.

1. **The Count.** The GM and the party tally the provisions, fuel, feed, and supplies laid in before the pass closed. This is the party's `Provisions` die (if used) and the town's or homestead's stores, counted against the months the winter will run.
2. **What Winter Brought.** Roll or choose on the table below for the season's character — the kind of winter the country got.
3. **The Attrition.** Apply the winter's pressure to the gauges — `Provisions` stepped down, `Horsestock` reduced, the conditions (`Freezing`, `Starving`) tested, the sickness chapter's outbreak risk climbed.
4. **The Spring Thaw.** Resolve the winter's end — who survived, what was lost, what the winter did to the gauges and the county.
...
| --- | --- |
| `Provisions` (food, coffee, salt, basic stores) | one step per month the winter runs, per body of people; step down on the usual `1-2` |
| Fuel (wood, coal) | one step per month, or the `Freezing` condition tests each Shift the fuel is short |
...
Roll `D66` or choose the winter the country got. The result sets the season's character and its specific pressures.

| D66 | The Winter |
| --- | --- |
| `11-13` | **The deep snow.** The pass closes early and stays closed. Travel is halted; the mail and the trade stop. `Provisions` step down twice over the season; `Horsestock` tests each month. |
| `14-16` | **The long cold.** Bitter, sustained cold without much snow. Fuel burns fast; `Freezing` tests each Shift the fuel is short. The stock suffer. |
| `21-23` | **The early thaw.** A mild winter that breaks in February. The stores hold; the gauges barely move; the county breathes. The early thaw is the winter's mercy, and it is rare. |
| `24-26` | **The wolf winter.** The game is scarce and the wolf pack comes to the corral. `Horsestock` and the ranch's stock test; a `HAWKEYE`/`SHOOTIN'` defense at the stock's cost, or the wolves take the calves. |
| `31-33` | **The fever winter.** The close air of the winter room is the sickness chapter's season. An outbreak tests the wintering body of people; `Welfare` drops; the doctor (if there is one) rolls the period's odds. |
| `34-36` | **The stranger at the door.** Someone comes in out of the snow — the stranded traveler, the fugitive, the frozen hand. The keeper's hardest trade (the sickness chapter's quarantine, the justice chapter's warrant, the simple human fact of the door). |
| `41-43` | **The cabin fever.** The winter room's close air breaks the peace. A feud (the families chapter) or a `Cohesion` test (the outlaw chapter) breaks the wintering body apart, in the cabin, in the dark. |
| `44-46` | **The frozen stock.** The hay runs short and the cold takes the herd. `Horsestock` reduced by `1` to `2`; a ranch's stock losses (the cattle chapter's Penalty column). |
...
Each month of the winter, apply the season's pressures to the gauges. The winter is the season the rest of the book's pressure gauges all climb at once.

- **`Provisions`** steps down each month, faster in a hard winter. At `D4`, the `Starving` condition tests; at exhausted, the county is hungry and the `Cohesion` tests with it.
- **`Horsestock`** steps down each month the feed is short, faster in a cold or wolf winter. A party afoot in the spring thaw is a party that lost its horses to the winter's hay.
- **`Cohesion`** (the outlaw band, the family, the wintering crew) tests each month the winter runs hard — the cabin fever, the short rations, the close air. A failed `Cohesion` test in the winter is a split, a feud, or a murder in the snow.
...
| --- | --- | --- |
| **Ration and conserve** | Step the Provisions die down slowly (roll depletion at `+1`, the rationing); tend the stores; make the count hold the months it was counted for. | Everyone tests `RESILIENCE` at `-1` for the hunger; the bodies weaken even as the stores hold. |
| **Cut wood and fuel** | A `LABOR` operation in the cold — the timber, the axe, the sled. Steps the Fuel die **up** by one; the cabin is warm and the `Freezing` tests are held. | The weather chapter's exposure (the Exposure gauge, Ch.19); a man in the timber in a storm is a man the cold can take. |
| **Tend the stock** | The `ANIMAL HANDLIN'` work — feed, water, break the ice, doctor the failing. Holds the `Horsestock` gauge; the animals survive the winter. | The weather's conditions; the stock are in the cold, and the hand with them is too. |
...
The winter's distinct cost is not in the stores or the stock. It is in the **cabin fever** — the close air of the winter room, the long dark, the forced company of people who cannot leave each other, the quarrel that becomes a feud that becomes a violence because there is nowhere to go and no one to mediate. Track this as a **Cabin Fever gauge** (`0`–`5`), the winter's social dimension, the inverse of `Cohesion` specific to the wintering.

| The Cabin Fever Gauge | What It Means |
| --- | --- |
| `0–2` | The household is holding. The company is tolerable; the peace is kept; the dark is endured. |
| `3` | **The tests begin.** The household tests `Cohesion` each month at `-1` — the quarrel, the grievance, the silence that is worse than the quarrel. |
...
>
> "You're cutting wood tomorrow," she said to the boy, and the boy started to argue, and she stopped him with the look that was the look she used for the ledger and the door bar and the things that were not arguments.
>
> "You're cutting wood tomorrow because the cabin fever is at three and the cornishman is at his cough and you are at your temper, and the wood that needs cutting is a mile up the draw and the cold will do you good. Put on the coat. Take the axe. Come back tired and the cabin will be easier."
>
...
Winter is the season the rest of the book's pressures converge, and the Winter Quarter is the frame that holds them.

- **The weather chapter** sets the winter's conditions and the blizzard disasters the Winter Quarter may produce.
- **The sickness chapter** is the winter's quiet killer — the close air, the fever, the outbreak that takes the cabin.
- **The conditions** (`Freezing`, `Starving`, `Exhausted`) are the winter's daily pressure, per the corebook.

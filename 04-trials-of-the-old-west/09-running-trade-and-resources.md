...
## Chapter 9 - Running Trade and Resources
...
> "Jesus, Mary."
>
> "You can haul it yourself," Sandoval said. "The road's open for three more days, maybe four. You've got the wagon and the team and the hands. All you're short is the contract and the Powder River crossing, which is mine."
>
> _The mine's man looked at the road, which was what he'd been looking at the whole time, and at the sky, which was what Sandoval had been looking at. He nodded once. She wrote the contract and put the pencil behind her ear and went to find Riddle, who would ride the Powder River crossing for her because that was the work he did now, and the work was honest, and the ledger said so._
...
When the party buys goods at the railhead or a strong market and carries them to a destination, the price they can charge is set by the miles, the road, the season, and the destination's need.

| Factor | Effect on Price |
| --- | --- |
| Base price | the railhead or strong-market price from the corebook's tables |
| Miles by wagon road | `+5%` per ten miles of decent road |
| Miles by pack trail | `+10%` per ten miles of trail (slower, smaller loads) |
| Hard country (mountains, desert, swamp) | double the per-mile cost |
...
The GM should not make this table a spreadsheet. Name a price that feels right for the road and the season and the buyer, check it against the table when the table is useful, and let the freighter and the buyer argue the figure the way Sandoval and the mine's man argued it. The argument is the trade.
...
| D66 | Freight Bonus | Freight Penalty |
| --- | --- | --- |
| `11-13` | A good contract held. `D6 × $40` in clean cash from a run well done. | A wagon or a string lost. `D6 × $50` in gear and stock; the road took its cut. |
| `14-16` | A buyer in a hurry. `+25%` on the next run's price; the country paid for its need. | A glut on the route. `-25%` on the season's take; too many freighters, not enough buyers. |
| `21-23` | The pass closed behind you. `D6 × $80` at famine prices, clean. | The pass closed in front of you. The goods are stranded; `-1` to `Cohesion` if the crew wintered on the wrong side. |
| `24-26` | A new route opened. `+1` Capital in contracts or stock, realized. | The railroad came through. The route is obsolete; the outfit must find a new one or go under. |
| `31-33` | A faction's backing. `+1` to the outfit's effective `Mercantile` next season. | A faction's enmity. `Standing` with a faction drops two steps; the road is closed to you. |
| `34-36` | A clean season, no losses. `+1` to next season's Freight Roll. | A raid or a robbery. `D6 × $75` in goods taken; test `Cohesion`. |
| `41-43` | The boom camp paid double. `D6 × $120` in cash. | The boom camp busted. The buyer is gone; the goods are worthless where they sit. |
| `44-46` | The army contract came through. `+1` Capital in steady business. | The army contract went to a rival. `-1` to `Mercantile` modifier for a season. |
...
| --- | --- | --- | --- |
| `Local Delivery` | `4` | `3` | A day or two on a known road; the county seat to the ranch, the railhead to the way-station |
| `Supply Run` | `6` | `4` | A week or more on the trail; the railhead to the mine, the post to the frontier |
| `The Long Haul` | `8` | `5` | Weeks in the country, the bad road, the closing season; the run that makes or breaks the year |

**Progress** is miles covered toward the destination. **Trouble** is everything the road throws at the run: weather (the weather chapter), broken axles and blown shoes, the river crossing that turns bad, the rustler who wants the stock and the freighter who wants the goods, the faction that closes the road or taxes the passage, and the simple attrition of animals and men on a long haul.

| Stage of the Run | The Problem | Likely Ability |
| --- | --- | --- |
| Loading and lashing | Get the goods on the wagon or the packs right, balanced, and sound | `LABOR`, `OPERATE` |
| The road | Cover the miles, hold the team, read the country | `OPERATE`, `ANIMAL HANDLIN'`, `HAWKEYE` |
| The water and the grass | Find the crossings, the camps, the feed for the animals | `NATURE`, `HAWKEYE` |
| The breakdown | Fix the wagon, the harness, the shoe, the tire, in the field | `MAKIN'`, `LABOR` |
| The country's people | Pay the toll, pass the faction's line, water at the spring | `PRESENCE`, `INSIGHT` |
| The delivery | Get the goods to the buyer in the condition the contract promises | `INSIGHT`, `PRESENCE` |

Each stage is tagged Safe / Risky / Desperate, as the outlaw chapter tags a score. A run on a known road in good weather is Safe; a run into hard country with a closing pass and a faction's enmity is Desperate, and the Trouble will tell.
...
Goods shipped by rail move at rail speeds and rail prices, and the party that has goods to move and a railhead to move them from will ship rather than haul. The rail's freight rate is a fraction of the wagon-haul cost per mile, and the rail carries more, faster, and in any weather the track will hold. Treat a rail shipment as a **Safe** operation of `Small` scale (`4` Progress, `3` Trouble) — the Progress is the goods making the train and arriving, and the Trouble is the missed connection, the damaged goods, the company's rate games, and the occasional robbery that catches the shipment in someone else's score.

A party shipping by rail rolls `OPERATE` (for the loading and the way-billing) or `INSIGHT` (for the dealing with the agent and the rate), with the town's `Mercantile` modifier applying to the dealing. The rail takes its cut, which is the freight rate; the rest is the profit on the trade.

#### The Schedule and the Price

The train's schedule sets the rhythm of the county's trade, and the GM should let it. The railhead gets its goods on the day the train sets them down, and the price across the county shifts with that day. A freighter who buys on the day the train arrives buys at the floor; a freighter who buys a week later, from a middleman who bought on the day, buys dearer. A town that the railroad has reached is a town on rail time; a town the railroad has not reached is a town on wagon time, and the difference between the two is the difference between a dollar-eighty sack of flour and a ten-dollar one.

A missed train, a cut wire, or a washed-out bridge (the weather chapter, the train robbery chapter) empties the railhead and sends the county's prices up the day it happens. A party that knows the bridge is out before the county does is a party that can buy cheap and sell dear, or run the goods the rail cannot, which is the freighter's whole trade in a single season.
...
| Resource | What It Is | When It Runs Short | What Scarcity Does |
| --- | --- | --- | --- |
| Flour and salt | the staff of the county's diet | a missed train, a bad harvest, a closed road | prices rise; `Starving` risk for the poor and the isolated |
| Powder and lead | the mine's tool and the fighter's | a run lost, a company embargo, a siege | the mine slows; the fighter counts his shots |
| Lumber and nails | the building trade's blood | a mill closed, a winter haul impossible | nothing gets built or repaired; the town shows it |
| Coal and oil | the lamp and the forge | a railhead shortage, a winter demand | the dark and the cold; `Freezing` risk |
| Medicine and spirits | the doctor's and the keeper's stock | a run not run, a company monopoly | the sick go untreated; the saloon goes dry |
